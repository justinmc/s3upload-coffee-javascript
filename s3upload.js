...
(function() {
  ...
  window.S3Upload = (function() {
    ...
    function S3Upload(options) {
      ...
      // Write our own _.extend to avoid dependency
      function extend(obj) {
    ...
    S3Upload.prototype.uploadFile = function(file, opts) {
      ...
      // Create a random filename to prevent 403 errors
      var opts = {name: Math.random().toString(36).slice(2) + '.' + file.name.split('.').pop()};
